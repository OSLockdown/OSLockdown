...
#
#  Disable HTTP upload capability for PHP
#
...
class PHPDisableHttpUpload:

    def __init__(self):

        self.logger = TCSLogger.TCSLogger.getInstance()
        self.module_name = 'PHPDisableHttpUpload'
        ...
        self.__php_settings = {}
        self.__php_settings['PHP'] = { 'file_uploads' : 'Off'}
    ...
    def scan(self, option=None):
        ...
        for section in self.__php_settings.keys():
            ...
            for subkey in subpair.keys():    
                ...
                msg = "Checking %s.%s == %s" % (section, subkey, subvalue)
    ...
    def apply(self, option=None):
        ...
        # Create new php.ini if it is missing
        if not os.path.isfile(self.__php_ini): 
            try:
