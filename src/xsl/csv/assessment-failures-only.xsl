...
<!-- $Id: assessment-failures-only.xsl 23802 2017-01-09 22:08:40Z rsanders $ -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <!-- =========================================================================
      ...
      Purpose: Failures Only Assessment Report XML to CSV
     =========================================================================
-->
    ...
    <xsl:template match="/">
        ...
        <xsl:for-each select="/AssessmentReport/modules/module[@results = 'Fail']">
