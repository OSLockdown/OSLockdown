...
<!-- =========================================================================
      ...
      Purpose: Undo Report XML to FO -> PDF
     =========================================================================
-->
 ...
 -->
      <fo:bookmark-tree>
        ...
        <xsl:if test="count(/UndoReport/modules/module[@results='Undone']) != 0">
          <fo:bookmark internal-destination="modulesUndone">
            <fo:bookmark-title>Undone</fo:bookmark-title>
          </fo:bookmark>
        </xsl:if>
        ...
        <xsl:if test="count(/UndoReport/modules/module[@results != 'Error' and @results != 'Undone']) != 0">
...
<!-- Totals -->
                        <xsl:variable name="totalFail" select="count(/UndoReport/modules/module[@results='Error'])"/>
                        <xsl:variable name="totalPass" select="count(/UndoReport/modules/module[@results='Undone'])"/>
...
<!-- 
      =======================================================================
          Results of Modules which were Undone
      =======================================================================
 -->
          <xsl:if test="count(/UndoReport/modules/module[@results='Undone']) != 0">
            <fo:table id="modulesUndone" table-layout="fixed" width="7.5in" xsl:use-attribute-sets="table">
 ...
 -->
          <xsl:if test="count(/UndoReport/modules/module[@results='Error']) != 0">
            <fo:table id="modulesWithErrors" table-layout="fixed" width="7.5in" xsl:use-attribute-sets="table">
              ...
              <fo:table-header>
                <fo:table-row xsl:use-attribute-sets="table-row-header">
                  <fo:table-cell padding="2px 5px 2px 5px" number-columns-spanned="2" border-width="0pt" text-align="left" display-align="center">
                    <fo:block font-weight="bold">Errors - Modules unable to be undone</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body>
 ...
 -->
          <xsl:if test="count(/UndoReport/modules/module[@results != 'Error' and @results != 'Undone']) != 0">
            <fo:table id="modulesNA" table-layout="fixed" width="7.5in" xsl:use-attribute-sets="table">
              ...
              <fo:table-header>
                <fo:table-row xsl:use-attribute-sets="table-row-header">
                  <fo:table-cell number-columns-spanned="2" padding="2px 5px 2px 5px"
                               border-width="0pt" text-align="left" display-align="center">
                    <fo:block>
              ...
              <fo:table-body>
                <xsl:for-each select="/UndoReport/modules/module[@results != 'Error' and @results != 'Undone']">
                  <xsl:sort select="@name"/>
