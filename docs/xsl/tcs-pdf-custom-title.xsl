...
<xsl:template name="book.titlepage">
  ...
  <fo:block-container absolute-position="absolute" left="0.2in" top="4.95in" width="7in" text-align="right">
    <fo:block font-family="Helvetica" font-size="20pt" font-weight="bold" color="#43B02A"><xsl:value-of select="/book/title"/></fo:block>
     <fo:block font-family="Helvetica" font-size="16pt" font-weight="bold"><xsl:value-of select="/book/subtitle"/></fo:block>
  </fo:block-container>
