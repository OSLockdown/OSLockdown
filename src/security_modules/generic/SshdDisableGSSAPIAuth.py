#!/usr/bin/env python
#
# Copyright (c) 20013 Forcepoint LLC.
...
class SshdDisableGSSAPIAuth(Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor):
    """
    ...
    def __init__(self):
        ...
        self.module_name    = "SshdDisableGSSAPIAuth"
