...
<tr class="row_odd">    
    <td class="propName" ><label for="Total Time">Time it took to run the scan</label>:</td>
    <td><dateFormat:printTime millis='${dataMap["totalTime"]}'/></td>
</tr>
<tr class="row_even">    
    <td class="propName" ><label for="Total Passed">Modules that passed</label>:</td>
    <td>${dataMap["totalPass"]}</td>
</tr>
<tr class="row_odd">    
