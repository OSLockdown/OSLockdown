...
#
# Disable SELinux MCS Translation Service (mctrans) 
#
# NOTE: The mcstransd daemon provides the category label translation information 
#       defined in /etc/selinux/targeted/setrans.conf to client processes which 
