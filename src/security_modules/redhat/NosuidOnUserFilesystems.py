...
class NosuidOnUserFilesystems:
    """
    NosuidOnUserFilesystems Security Module modifies fstab so that 
    ...
    def __init__(self):
        ...
        self.__user_filesystems = ['/boot', '/home', '/usr/home']
    ...
    def apply(self, option=None):
        ...
        for line in origfile:
            ...
            line = '%s %s %s %s %s %s\n' % (dev, mt_point, fs_type,
                                            new_options, d, p)
            msg = "Adding 'nosuid' mount option to '%s' in /etc/fstab" % (mt_point)
