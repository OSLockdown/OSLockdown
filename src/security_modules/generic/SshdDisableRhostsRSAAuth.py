...
class SshdDisableRhostsRSAAuth(Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor):
    """
    SshdDisableRhostsRSAAuth Security Module handles the guideline for 
    disabling rhostsrsaauthentication.
    """
    def __init__(self):
        Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor.__init__(self)
        self.module_name = "SshdDisableRhostsRSAAuth"

        self.configfile = '/etc/ssh/sshd_config'
        self.settings = [ ['RhostsRSAAuthentication', 'no',self._isEqualTo], 
                        ]
