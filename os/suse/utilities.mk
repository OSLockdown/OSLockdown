...
#
# OS Lockdown - Variables for common utilities (SUSE)
#
...
export PKGINSTALL  := /usr/bin/zypper in 
...
## the product:
export REQDPKGS := byacc gcc gcc-c++ swig openssl-devel binutils bison xmlto python-devel zlib-devel linux-kernel-headers flex 
