...
#
# Password Policy - Set minumum number numerical characters
#                   that must be in a password
#
# Set MINNONALPHA in /etc/default/passwd
#
...
class PasswordPolicyNumbers:
    ...
    def scan(self, option):
        ...
        if not option: 
            option = '2'
            msg = 'No option value provided; defaulting to 2'
