...
class SetStrictMultihoming:
    ##########################################################################
    def __init__(self):

        self.module_name = "SetStrictMultihoming"
        ...
        self.__desc        = 'Set Strict Multihoming'
        self.__param       = {  'ip_strict_dst_multihoming': 1, 
