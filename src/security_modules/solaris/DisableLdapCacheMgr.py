...
class DisableLdapCacheMgr:

    def __init__(self):

        self.module_name = 'DisableLdapCacheMgr'
        self.__target_file = ''
        ...
        #
        self.__svcname = ['svc:/network/ldap/client:default']
        self.__svcdesc = 'LDAP client (cache manager)'
        self.__pkgname = 'SUNWcsr'
