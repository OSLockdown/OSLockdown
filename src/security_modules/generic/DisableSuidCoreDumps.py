...
class DisableSuidCoreDumps:

    def __init__(self):
        self.module_name = "DisableSuidCoreDumps"
        ...
        self.__settings = {'fs.suid_dumpable': 0 }
    ...
    def scan(self, option=None):
        ...
        if failure_flag == True:
            return False, 'SUID core dumps are enabled', messages
        else:
            return True, 'SUID core dumps are disabled', messages
