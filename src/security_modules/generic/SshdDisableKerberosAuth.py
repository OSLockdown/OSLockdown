...
class SshdDisableKerberosAuth(Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor):
    """
    ...
    def __init__(self):
        ...
        self.module_name    = "SshdDisableKerberosAuth"

        self.configfile = '/etc/ssh/sshd_config'
        self.settings = [ ['KerberosAuthentication', 'no',self._isEqualTo], 
                        ]
