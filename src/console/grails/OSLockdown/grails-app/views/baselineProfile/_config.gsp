<div style="padding-top:0.5em;">
  <table>
    ...
    <g:textField class="input" name="name" onKeyUp="limitText(this.form.name,35);" value="${baselineProfileInstance?.name}" size="30" title="Enter Profile Name" />
    </td>
  ...
  <div id="div_extraInfo" style="display:none;">
    <table class="enterprise pad5all">
      <tr>
        ...
        <td><g:textField class="input" name="summary" value="${baselineProfileInstance?.summary}" size="60" onKeyUp="limitText(this.form.summary,80);" title="Enter Short Description" /></td>
      </tr>
      <tr>
        ...
        <td><g:textArea class="input" name="description" value="${baselineProfileInstance?.description}" rows="5" cols="62" wrap="soft"/></td>
      </tr>
      <tr>
        <td style="vertical-align:top;" class="profileName" title="Comments"><label for="Comments">Comments</label>:</td>
        <td><g:textArea class="input" name="comments" value="${baselineProfileInstance?.comments}" rows="5" cols="62" wrap="soft"/></td>
      </tr>
    </table>
  </div>
</div>