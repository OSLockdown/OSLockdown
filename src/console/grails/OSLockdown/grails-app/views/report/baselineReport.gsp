...
<html>
  <head>
    ...
    <meta name="contextSensitiveHelp" content="baselines" />
          ...
          <div class="info sixty centerDiv">
            <div class="info_body">
              <g:form name="viewReportForm" controller="report" action="viewRenderedReport" target="_blank">
                  ...
                  <fieldset>
                    ...
                    <div class="pad1TopBtm center">
                      <select class="paddedSelect" name="reportType" id="reportType">
                        <option value="${ReportType.BASELINE.ordinal()}">${ReportType.BASELINE.displayString}</option>
                      </select>
                    </div>
                  </fieldset>
                </div>
                ...
                <div class="pad1Top" style="text-align:center;">
