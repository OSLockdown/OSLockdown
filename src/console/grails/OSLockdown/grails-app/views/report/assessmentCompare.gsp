...
<html>
  <head>
    ...
    <meta name="contextSensitiveHelp" content="compare-assessments" />
    <title>Compare Assessment Reports</title>
    ...
    <r:script>
      ...
      function showReportList(clientId,comparisonId) {
        ...
        ajaxRequest.addNameValuePair('reportType',"${ReportType.ASSESSMENT.ordinal()}");
  ...
  <body id="reports">
    <div id="per_page_container">
      <div class="container" id="per_page_header" title="Compare Assessment Reports">
        <div class="headerLeft">
          <h1>Compare Assessment Reports</h1>
        </div>
      </div>
      <div id="yui-main">
        <div id="main_content" class="subpage">
          <div class="info sixty centerDiv">
            <div class="reports info_body">
              <g:form controller="report" action="compareAssessmentReports" target="_blank">
                <g:hiddenField name="reportType" value="${ReportType.ASSESSMENT_COMPARISON.ordinal()}" />
