...
class SshdDisableHostbasedAuth(Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor):
    """
    SshdDisableHostbasedAuth Security Module handles the guideline for 
    disabling HostbasedAuthentication.
    """

    def __init__(self):
        Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor.__init__(self)
        self.module_name = "SshdDisableHostbasedAuth"

        self.configfile = '/etc/ssh/sshd_config'
        self.settings = [ ['HostbasedAuthentication', 'no',self._isEqualTo], 
                        ]
