...
<html>
  <head>
    ...
    <meta name="contextSensitiveHelp" content="undo" />
    <title>Undo Report</title>
    ...
    <r:script>
      ...
      function choiceMade() {
        ...
        ajaxRequest.addNameValuePair('reportType','${ReportType.UNDO.ordinal()}');
                  ...
                  <fieldset>
                    ...
                    <div class="pad1TopBtm center">
                      <select class="paddedSelect" name="reportType" id="reportType">
                        <option value="${ReportType.UNDO.ordinal()}">${ReportType.UNDO.displayString}</option>
                      </select>
                    </div>
                  </fieldset>
                </div>
