...
<!-- =========================================================================
      ...
      Purpose: Assessment Report XML to FO -> PDF
     =========================================================================
-->
...
<!-- Profile Information -->
              <fo:table-row color="black" border-bottom="1px solid {$table.color}">
                ...
                <fo:table-cell padding="2px 5px 2px 5px" border-width="0pt" text-align="left" display-align="center">
                  ...
                  <xsl:if test="count(/AssessmentReport/modules/module[@results='Module Unavailable']) != 0">
                    <fo:block margin-left="10px" margin-top="10px" margin-bottom="10px" color="red" font-size="90%">
                      <fo:inline font-weight="bold">NOTE: </fo:inline> This profile contained some 
                      modules which were not available (marked as
                      <fo:inline font-style="italic">Module Unavailable</fo:inline>).
                       This usually indicates an older version of OS Lockdown is installed
                       on client machines.
                    </fo:block>
                  </xsl:if>
              ...
              <fo:table-header>
                <fo:table-row xsl:use-attribute-sets="table-row-header">
                  <fo:table-cell padding="2px 5px 2px 5px" border-width="0pt"
                    ...
                    <fo:block font-weight="bold">High Risk</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
