...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <!-- =========================================================================
     ...
     or visit https://www.gnu.org/licenses/gpl.html instead.
      ...
      Purpose: Failed Modules Report XML to TEXT
     =========================================================================
-->
    ...
    <xsl:template match="/">
        ...
        <xsl:if test="count(/AssessmentReport/modules/module[@results='Fail']) != 0">
            <xsl:text>Failed Modules:&#x0A;</xsl:text>
            <xsl:text>--------------------------------------------------------------------</xsl:text>
        </xsl:if>

        <xsl:if test="count(/AssessmentReport/modules/module[@results='Fail' and @severity='High']) != 0">
        ...
        <xsl:if test="count(/AssessmentReport/modules/module[@results='Fail' and @severity='Medium']) != 0">
