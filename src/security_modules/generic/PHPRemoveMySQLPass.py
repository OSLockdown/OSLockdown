...
class PHPRemoveMySQLPass:
    def __init__(self):
        ...
        self.module_name = 'PHPRemoveMySQLPass'
        ...
        self.__php_settings = {}
        self.__php_settings['MySQL'] = { 'mysql.default_password' : ''}
    ...
    def undo(self, change_record=None):
        ...
        if change_record == None or change_record == "":
