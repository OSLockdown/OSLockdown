...
class SshdRestrictCiphers(Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor):

    def __init__(self):
        Ssh_Sshd_ConfigEditor.Ssh_Sshd_ConfigEditor.__init__(self)
        self.module_name = "SshdRestrictCipher"
        
        self.configfile = '/etc/ssh/sshd_config'
        # Settings here don't matter, _restrictCiphers will process whatever was in the file *if anything*
