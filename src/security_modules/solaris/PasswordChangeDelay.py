...
#
# Password Policy -  Minimum allowed time between password changes.
#
# Set MINWEEKS in /etc/default/passwd
#
...
class PasswordChangeDelay:
    ...
    def scan(self, optionDict):
        ...
        # Solaris stores this value as weeks instead of days
        # So, convert the option value by dividing it by seven
        option = str(int(option)/7)
