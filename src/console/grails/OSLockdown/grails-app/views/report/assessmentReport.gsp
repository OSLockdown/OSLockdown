...
<html>
  <head>
    ...
    <meta name="contextSensitiveHelp" content="assessments" />
                  ...
                  <fieldset>
                    ...
                    <div class="pad1TopBtm center">
                      <select class="paddedSelect" name="reportType" id="reportType">
                        <option value="${ReportType.ASSESSMENT.ordinal()}">${ReportType.ASSESSMENT.displayString}</option>
                        <option value="${ReportType.ASSESSMENT_FAILURES.ordinal()}">${ReportType.ASSESSMENT_FAILURES.displayString}</option>
                      </select>
                    </div>
                  </fieldset>
                </div>
