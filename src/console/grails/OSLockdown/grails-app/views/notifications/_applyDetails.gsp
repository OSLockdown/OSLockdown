...
<tr class="row_odd">    
    <td class="propName" ><label for="Total Time">Time it took to run the apply</label>:</td>
    <td><dateFormat:printTime millis='${dataMap["totalTime"]}'/></td>
</tr>
<tr class="row_even">    
    <td class="propName" ><label for="Total Applied">Modules that applied</label>:</td>
    <td>${dataMap["totalApply"]}</td>
</tr>
<tr class="row_odd">    
